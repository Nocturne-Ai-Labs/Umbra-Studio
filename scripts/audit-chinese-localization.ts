...
console.log(`[i18n:zh-CN] ${translatedCount}/${values.size} static UI phrases localized (${coverage}%).`);
...
if (coverage < MINIMUM_STATIC_COVERAGE) {
  console.error(`[i18n:zh-CN] Coverage fell below the ${MINIMUM_STATIC_COVERAGE}% regression floor.`);
