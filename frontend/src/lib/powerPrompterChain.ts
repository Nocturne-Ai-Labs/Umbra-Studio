...
import { normalizeWildcardRerolls, sortPowerPrompterCards } from '@/lib/powerPrompter';
import {
...
function normalizeQueueSetOrders(rawOrders: unknown, allowedSetIds: number[], fallbackOrder: number): Record<string, number> {
